...
\begin{algorithmic}[1]
	...
	\Procedure{co-languages}{$i$, $F_i$, $N_i$}
		\ForAll{$j \in I \mid j \textrm{ is adjacent to } i$}
			\State $F'_j \leftarrow (C_j^{-1} \cap F_i^{-1})\cap C_j$
			\State $N'_j \leftarrow (C_j^{-1} \cap N_i^{-1})\cap C_j$
			\State $K \leftarrow F'_j \cap N'_j$
...
\begin{enumerate}
  ...
  there is a indeterminate cycle, under assumption that the languages are
