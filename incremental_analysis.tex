...
\node [below] at (2.5,0) {1/Number of modules};
...
\node[right] at (1,-1) {Average size of module (states)};
\draw[red, thick, dashed] (0,-1.5) -- (1,-1.5);
\node[right] at (1,-1.5) {Average size of diagnoser (states)};
\draw[orange, thick, dotted] (0,-2) -- (1,-2);
\node[right] at (1,-2) {Amount of communications (events)};
